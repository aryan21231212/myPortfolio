  ...
  return (
    ...
    <h1 style={{letterSpacing:"1.2px", marginTop:"20rem"}} className='text-center'>Portfolio</h1>
      ...
      <div className='box'>
        ...
        <Card deploy='code-reviewer-sz77.vercel.app' github ='https://github.com/aryan21231212/code-reviewer' h1='code-reviewer' p='AI-powered website for instant code review using the Gemini API.'></Card>
        ...
        <Card deploy='chat-bot-phi-ebon.vercel.app' github ='https://github.com/aryan21231212/chatBot' h1='chatBot' p='AI chatbot website for interactive, human-like conversations.'></Card>
